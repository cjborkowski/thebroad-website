...
?>
<!-- thebroad/templates/node-aboutpages.tpl.php Adaptive theme master template for all About pages -->
<article id="node-<?php print $node->nid; ?>" class="thebroad-about-node  <?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <?php endif; ?>
   <?php if (isset($field_preview_sharing_image)): ?>  
   
   <div id="preview-image">
  <?php print render($content['field_preview_sharing_image']); ?>
  </div>
