...
hide($content['links']);
?>
<!-- thebroad/templates/node--art_pages.tpl.php Adaptive theme master template for art pages -->

<a id ="<?php print $node->nid; ?>"></a>
<?php if ($teaser): ?>
	<!--teaser node -->
<div id="art-pages-teaser-node-id-<?php print $node->nid;?>" class="art-pages-teaser">	
<?php else : ?>
	<!--art_pages full node -->
<div id="art-pages-node-id-<?php print $node->nid;?>" class="art-pages-node">	
<?php endif;?>
<div class="art-pages-node-inner-wrapper">	
    ...
    <header<?php print $header_attributes; ?>>
      <?php if ($title): ?>
        <h1<?php print $title_attributes; ?>>
          <a href="<?php print $node_url; ?>" rel="bookmark"><?php print $title; ?></a><!--art_pages node title -->
        </h1>
      <?php endif; ?>
    </header>
  <?php endif; ?>
