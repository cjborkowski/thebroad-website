...
//dpm ($content['field_lightbox_image']);
?>
<!-- thebroad/templates/node-building_pages).tpl.php master template for building nodes -->
...
<article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div<?php print $content_attributes; ?>>
    <?php if ( isset($content['field_lightbox_image']) ) {
    			
    		if( count($content['field_lightbox_image']['#items']) > 1 ){
    		print '<div class="thebroad-lightbox">';		
    		} else {
    		print '<div class="thebroad-lightbox-single-image">';
    		}
		
    	print render ($content['field_lightbox_image']);
    	print '<div style="clear:both;"></div></div><!-- end thebroad-lightbox -->';
		print '<!-- image count: '.count($content['field_lightbox_image']['#items']).'-->';
		 }//end if
    ?>
